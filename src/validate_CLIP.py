...
blur_dataset = kaggle50k_dataset.Kaggle50K(config["data"]["test_manifest"], transform=blur_transform)
occlusion_dataset = kaggle50k_dataset.Kaggle50K(config["data"]["test_manifest"], transform=occlusion_transform)
illumination_dataset = kaggle50k_dataset.Kaggle50K(config["data"]["test_manifest"], transform=illumination_transforms)
...
base_accuracies = test(base_dataset, base_inv_map)
blur_accuracies = test(blur_dataset, blur_inv_map)
occlusion_accuracies = test(occlusion_dataset, occlusion_inv_map)
illumination_accuracies = test(illumination_dataset, illumination_inv_map)
